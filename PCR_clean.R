...
# PCR_clean: Cleaning raw data for PCR project
# Script #1 in PCR project
...
AB_treatments <- read_csv("M:/PCR_data/AB_treatments.csv") # AB treated diseases identified by Søren & Jeanette
# vetpcr
...
#------------------------------------------------------------------
# breed; create dataset with only animal ID and breed (NA when merging: rename to `other`)
...
save.image("M:/PCR_data/PCR_clean.RData")
