...
# to do
## check: df11: Unknown or uninitialised column: `OTHER_AB`.
## df_all_dates: Many NAs in RES_major, RES_minor. 0 and 1 have been applied..
...
#--------------------------------------------------------------------
## df3 + df4: + calvings (create DIM + parity + Calving_month/dryoff_month + calving outcome)
